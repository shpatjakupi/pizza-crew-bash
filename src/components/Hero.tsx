    ...
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 lg:py-32">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2 z-10 order-1">
          ...
          {/* Image - will be the third element on mobile (after buttons), second on desktop */}
          <div className="w-full lg:w-1/2 relative order-2">
            <div className="relative w-full h-[420px] md:h-[520px] lg:h-[620px] overflow-hidden rounded-xl shadow-2xl float-animation">
              <img
